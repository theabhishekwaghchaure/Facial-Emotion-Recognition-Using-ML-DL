...
def files_count():
    ...
    if int(number_of_Happy_files) > int(number_of_Fear_files) and int(number_of_Happy_files) > int(number_of_sad_files) and int(number_of_Happy_files) > int(number_of_neutral_files):
        ...
        a = ms.showinfo("Message", "Person is HAPPY MOOD")
        ...
        a = ms.showinfo("Message", "Person is Fearful MOOD")
        ...
        a = ms.showinfo("Message", "Person is Neutral MOOD")
        ...
        a = ms.showinfo("Message", "Person is Sad MOOD")
        
        
    elif int(number_of_Disgusted_files) > int(number_of_Happy_files) and int(number_of_Disgusted_files) > int(number_of_sad_files) and int(number_of_neutral_files) > int(number_of_Fear_files):
            a = ms.showinfo("Message", "Person is disgusted MOOD")
           
    elif int(number_of_Surprised_files) > int(number_of_Happy_files) and int(number_of_Surprised_files) > int(number_of_sad_files) and int(number_of_neutral_files) > int(number_of_Fear_files):
                a = ms.showinfo("Message", "Person is Neutral MOOD")
